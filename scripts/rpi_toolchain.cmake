...
set(CMAKE_C_FLAGS "-mcpu=cortex-a53 -mfpu=neon-vfpv4 -mfloat-abi=hard ${COMMON_FLAGS} -Wl,--sysroot=${RASPBERRY_ROOT_FS}" CACHE STRING "Flags for Raspberry PI 3")
set(CMAKE_CXX_FLAGS "${CMAKE_C_FLAGS}" CACHE STRING "Flags for Raspberry PI 3")

set(CMAKE_FIND_ROOT_PATH ${RASPBERRY_ROOT_FS})
